/*! For license information please see tsparticles.preset.fire.bundle.min.js.LICENSE.txt */ ! function (t, i) {
    ...
    return function () {
        ...
        function b(t) {
            if (!g() && "undefined" != typeof matchMedia) return matchMedia(t)
        }
        ...
        function x(t, i, e = !0) {
            return t[void 0 !== i && e ? i % t.length : function (t) {
            ...
            for (const e of i) {
                ...
                for (const i in e) {
                    ...
                    const s = e[i],
                        o = "object" == typeof s,
                        n = t;
                    n[i] = o && Array.isArray(s) ? s.map((t => M(n[i], t))) : M(n[i], s)
                }
            }
            return t
        }
        ...
        function P(t, i) {
            return t instanceof Array ? t.map((t => i(t))) : i(t)
        }

        function k(t, i, e) {
            return t instanceof Array ? x(t, i, e) : t
        }
        const O = "random",
            C = new Map;
        ...
        function R(t, i, e = !0) {
            ...
            if ("string" == typeof s.value) return D(s.value, i, e);
            if (s.value instanceof Array) return R({
                value: x(s.value, i, e)
            });
            for (const [, t] of C) {
        ...
        function D(t, i, e = !0) {
            ...
            if ("string" == typeof s.value) return s.value === O ? F() : function (t) {
                return T(t)
            }(s.value);
            if (s.value instanceof Array) return D({
                value: x(s.value, i, e)
            });
            for (const [, t] of C) {
        ...
        function A(t) {
            ...
            if (e.s) {
                const t = e.l < .5 ? e.l * (1 + e.s) : e.l + e.s - e.l * e.s,
                    s = 2 * e.l - t;
                i.r = I(s, t, e.h + 1 / 3), i.g = I(s, t, e.h), i.b = I(s, t, e.h - 1 / 3)
        ...
        function q(t, i, e) {
            t.enable = i.enable, t.enable ? (t.velocity = c(i.speed) / 100 * e, t.decay = 1 - c(i.decay), t.status = 0, i.sync || (t.velocity *= a(), t.value *= a())) : t.velocity = 0
        }
        ...
        class $ {
            ...
            clear() {
                ...
                t.backgroundMask.enable ? this.paint() : i.enable && i.length > 0 && this._trailFillColor ? this._paintBase(H(this._trailFillColor, 1 / i.length)) : this.draw((t => {
                    U(t, this.size)
                }))
            }
            destroy() {
                var t;
                this._generatedCanvas ? null === (t = this.element) || void 0 === t || t.remove() : this._resetOriginalStyle(), this.draw((t => {
                    U(t, this.size)
            ...
            drawParticle(t, i) {
                ...
                a || (a = o), r || (r = n), (a || r) && this.draw((e => {
                    ...
                    const d = this.container.actualOptions,
                        u = t.options.zIndex,
                        p = (1 - t.zIndexFactor) ** u.opacityRate,
                        v = null !== (l = null !== (o = t.bubble.opacity) && void 0 !== o ? o : null === (n = t.opacity) || void 0 === n ? void 0 : n.value) && void 0 !== l ? l : 1,
                        f = v * p,
                        m = (null !== (h = null === (c = t.stroke) || void 0 === c ? void 0 : c.opacity) && void 0 !== h ? h : v) * p,
                        y = {},
                        g = {
                            fill: a ? V(a, f) : void 0
                        };
                    g.stroke = r ? V(r, m) : g.fill, this._applyPreDrawUpdaters(e, t, s, f, g, y),
                        function (t) {
                            var i, e, s, o, n, a, r, l, c, h;
                            const {
                                container: d,
                                context: u,
                                particle: p,
                            ...
                            u.save(), void 0 !== x.a || void 0 !== x.b || void 0 !== x.c || void 0 !== x.d ? u.setTransform(null !== (i = x.a) && void 0 !== i ? i : 1, null !== (e = x.b) && void 0 !== e ? e : 0, null !== (s = x.c) && void 0 !== s ? s : 0, null !== (o = x.d) && void 0 !== o ? o : 1, z.x, z.y) : u.translate(z.x, z.y), u.beginPath();
                            const _ = p.rotation + (p.pathRotation ? p.velocity.angle : 0);
                            0 !== _ && u.rotate(_), m && (u.globalCompositeOperation = y);
                            const M = p.shadowColor;
                            w.enable && M && (u.shadowBlur = w.blur, u.shadowColor = H(M), u.shadowOffsetX = w.offset.x, u.shadowOffsetY = w.offset.y), f.fill && (u.fillStyle = f.fill);
                            const P = p.stroke;
                            u.lineWidth = null !== (n = p.strokeWidth) && void 0 !== n ? n : 0, f.stroke && (u.strokeStyle = f.stroke),
                                function (t, i, e, s, o, n) {
                                    if (!e.shape) return;
                                    const a = t.drawers.get(e.shape);
                                    a && a.draw(i, e, s, o, n, t.retina.pixelRatio)
                                }(d, u, p, g, b, v), (null !== (a = null == P ? void 0 : P.width) && void 0 !== a ? a : 0) > 0 && u.stroke(), p.close && u.closePath(), p.fill && u.fill(), u.restore(), u.save(), void 0 !== x.a || void 0 !== x.b || void 0 !== x.c || void 0 !== x.d ? u.setTransform(null !== (r = x.a) && void 0 !== r ? r : 1, null !== (l = x.b) && void 0 !== l ? l : 0, null !== (c = x.c) && void 0 !== c ? c : 0, null !== (h = x.d) && void 0 !== h ? h : 1, z.x, z.y) : u.translate(z.x, z.y), p.rotation && u.rotate(p.rotation), m && (u.globalCompositeOperation = y),
                                function (t, i, e, s, o, n) {
                                    if (!e.shape) return;
                                    const a = t.drawers.get(e.shape);
                                    (null == a ? void 0 : a.afterEffect) && a.afterEffect(i, e, s, o, n, t.retina.pixelRatio)
                                }(d, u, p, g, b, v), u.restore()
                        }({
            ...
            drawParticlePlugin(t, i, e) {
                this.draw((s => {
                    ! function (t, i, e, s) {
                        i.drawParticle && (t.save(), i.drawParticle(t, e, s), t.restore())
                    }(s, t, i, e)
                }))
            }
            drawPlugin(t, i) {
            ...
            initBackground() {
                ...
                if (e) {
                    if (t.color) {
                        const i = R(t.color);
                        e.backgroundColor = i ? H(i, t.opacity) : ""
            ...
            loadCanvas(t) {
                var i;
                this._generatedCanvas && (null === (i = this.element) || void 0 === i || i.remove()), this._generatedCanvas = t.dataset && B in t.dataset ? "true" === t.dataset.generated : this._generatedCanvas, this.element = t, this._originalStyle = M({}, this.element.style), this.size.height = t.offsetHeight, this.size.width = t.offsetWidth, this._context = this.element.getContext("2d"), this.container.retina.init(), this.initBackground()
            }
            paint() {
                const t = this.container.actualOptions;
                this.draw((i => {
                    t.backgroundMask.enable && t.backgroundMask.cover ? (U(i, this.size), this._paintBase(this._coverColorStyle)) : this._paintBase()
                }))
            }
            resize() {
            ...
            _applyResizePlugins() {
                var t;
                for (const i of this._resizePlugins) null === (t = i.resize) || void 0 === t || t.call(i)
            }
            _getPluginParticleColors(t) {
                let i, e;
                for (const s of this._colorPlugins)
                    if (!i && s.particleFillColor && (i = L(s.particleFillColor(t))), !e && s.particleStrokeColor && (e = L(s.particleStrokeColor(t))), i && e) break;
                return [i, e]
            }
            _initCover() {
            ...
            _initStyle() {
                ...
                if (t) {
                    i.fullScreen.enable ? (this._originalStyle = M({}, t.style), t.style.setProperty("position", "fixed", "important"), t.style.setProperty("z-index", i.fullScreen.zIndex.toString(10), "important"), t.style.setProperty("top", "0", "important"), t.style.setProperty("left", "0", "important"), t.style.setProperty("width", "100%", "important"), t.style.setProperty("height", "100%", "important")) : this._resetOriginalStyle();
            ...
            _initTrail() {
                const t = this.container.actualOptions,
                    i = R(t.particles.move.trail.fillColor);
                if (i) {
        ...
        class J {
            ...
            doMouseTouchClick(t) {
                ...
                if (this.canPush) {
                    ...
                    if (!t) return;
                    i.interactivity.mouse.clickPosition = Object.assign({}, t), i.interactivity.mouse.clickTime = (new Date).getTime();
                    P(e.interactivity.events.onClick.mode, (t => this.handleClickMode(t)))
                }
            ...
            manageListeners(t) {
                ...
                let n = X;
                if ("window" === o) e.interactivity.element = window, n = "pointerout";
                else if ("parent" === o && e.canvas.element) {
                ...
                const a = b("(prefers-color-scheme: dark)");
                a && (void 0 !== a.addEventListener ? N(a, "change", this.themeChangeHandler, t) : void 0 !== a.addListener && (t ? a.addListener(this.oldThemeChangeHandler) : a.removeListener(this.oldThemeChangeHandler)));
                const r = e.interactivity.element;
                if (!r) return;
                const l = r;
                (s.interactivity.events.onHover.enable || s.interactivity.events.onClick.enable) && (N(r, j, this.mouseMoveHandler, t), N(r, "touchstart", this.touchStartHandler, t), N(r, "touchmove", this.touchMoveHandler, t), s.interactivity.events.onClick.enable ? (N(r, G, this.touchEndClickHandler, t), N(r, "pointerup", this.mouseUpHandler, t), N(r, "pointerdown", this.mouseDownHandler, t)) : N(r, G, this.touchEndHandler, t), N(r, n, this.mouseLeaveHandler, t), N(r, "touchcancel", this.touchCancelHandler, t)), e.canvas.element && (e.canvas.element.style.pointerEvents = l === e.canvas.element ? "initial" : "none"), s.interactivity.events.resize && ("undefined" != typeof ResizeObserver ? this.resizeObserver && !t ? (e.canvas.element && this.resizeObserver.unobserve(e.canvas.element), this.resizeObserver.disconnect(), delete this.resizeObserver) : !this.resizeObserver && t && e.canvas.element && (this.resizeObserver = new ResizeObserver((t => {
                    t.find((t => t.target === e.canvas.element)) && this.handleWindowResize()
                })), this.resizeObserver.observe(e.canvas.element)) : N(window, "resize", this.resizeHandler, t)), document && N(document, "visibilitychange", this.visibilityChangeHandler, t, !1)
            }
            mouseDown() {
            ...
            mouseTouchFinish() {
                ...
                if (!t) return;
                const i = t.mouse;
                delete i.position, delete i.clickPosition, delete i.downPosition, t.status = X, i.inside = !1, i.clicking = !1
            }
            mouseTouchMove(t) {
                var i, e, s, o, n, a, r;
        ...
        class K {
            ...
            load(t) {
                t && (void 0 !== t.color && (this.color = Q.create(this.color, t.color)), void 0 !== t.image && (this.image = t.image), void 0 !== t.position && (this.position = t.position), void 0 !== t.repeat && (this.repeat = t.repeat), void 0 !== t.size && (this.size = t.size), void 0 !== t.opacity && (this.opacity = t.opacity))
            }
        }
        class tt {
            constructor() {
                this.color = new Q, this.color.value = "#fff", this.opacity = 1
            }
            load(t) {
                t && (void 0 !== t.color && (this.color = Q.create(this.color, t.color)), void 0 !== t.opacity && (this.opacity = t.opacity))
            }
        }
        class it {
            constructor() {
                this.composite = "destination-out", this.cover = new tt, this.enable = !1
            }
            load(t) {
                if (t) {
        ...
        class ot {
            ...
            get ids() {
                return P(this.selectors, (t => t.replace("#", "")))
            }
            set ids(t) {
                this.selectors = P(t, (t => `#${t}`))
            }
            load(t) {
                var i, e;
                if (!t) return;
        ...
        class at {
            constructor() {
                this.enable = !1, this.mode = [], this.parallax = new nt
            }
            load(t) {
        ...
        class rt {
            constructor() {
                this.onClick = new st, this.onDiv = new ot, this.onHover = new at, this.resize = !0
            }
            get onclick() {
                return this.onClick
            }
            ...
            load(t) {
                ...
                void 0 !== o && (this.onDiv = P(o, (t => {
                    const i = new ot;
                    return i.load(t), i
                }))), this.onHover.load(null !== (s = t.onHover) && void 0 !== s ? s : t.onhover), void 0 !== t.resize && (this.resize = t.resize)
            }
        }
        class lt {
            constructor(t, i) {
        ...
        class ct {
            constructor(t, i) {
                this.detectsOn = "window", this.events = new rt, this.modes = new lt(t, i)
            }
            get detect_on() {
        ...
        class ht {
            load(t) {
                ...
                }), void 0 !== t.options && (this.options = M({}, t.options)))
            }
        }
        class dt {
            constructor() {
        ...
        class ut {
            constructor() {
                this.disable = !1, this.reduce = new dt
            }
            load(t) {
        ...
        class pt {
            ...
            load(t) {
                t && (void 0 !== t.maxWidth && (this.maxWidth = t.maxWidth), void 0 !== t.mode && ("screen" === t.mode ? this.mode = "screen" : this.mode = "canvas"), void 0 !== t.options && (this.options = M({}, t.options)))
            }
        }
        class vt {
            constructor() {
        ...
        class ft {
            constructor() {
                this.name = "", this.default = new vt
            }
            load(t) {
                t && (void 0 !== t.name && (this.name = t.name), this.default.load(t.default), void 0 !== t.options && (this.options = M({}, t.options)))
            }
        }
        class mt {
            constructor() {
        ...
        class xt {
            constructor() {
                this.random = new wt, this.value = 0
            }
            load(t) {
        ...
        class _t {
            constructor() {
                this.horizontal = new zt, this.vertical = new zt
            }
            load(t) {
        ...
        class Mt {
            constructor() {
                this.bounce = new _t, this.enable = !1, this.mode = "bounce", this.overlap = new bt
            }
            load(t) {
        ...
        class St {
            constructor() {
                this.clamp = !0, this.delay = new Ct, this.enable = !1, this.options = {}
            }
            load(t) {
                t && (void 0 !== t.clamp && (this.clamp = t.clamp), this.delay.load(t.delay), void 0 !== t.enable && (this.enable = t.enable), this.generator = t.generator, t.options && (this.options = M(this.options, t.options)))
            }
        }
        class It {
            constructor() {
                this.enable = !1, this.length = 10, this.fillColor = new Q, this.fillColor.value = "#000000"
            }
            load(t) {
                t && (void 0 !== t.enable && (this.enable = t.enable), this.fillColor = Q.create(this.fillColor, t.fillColor), void 0 !== t.length && (this.length = t.length))
            }
        }
        class Tt {
            constructor() {
        ...
        class Rt {
            ...
            load(t) {
                t && (void 0 !== t.acceleration && (this.acceleration = u(t.acceleration)), void 0 !== t.enable && (this.enable = t.enable), this.position = t.position ? M({}, t.position) : void 0)
            }
        }
        class Dt {
            constructor() {
                this.angle = new Pt, this.attract = new kt, this.center = {
                    x: 50,
                    y: 50,
                    mode: "percent",
                    radius: 0
                }, this.decay = 0, this.distance = {}, this.direction = "none", this.drift = 0, this.enable = !1, this.gravity = new Ot, this.path = new St, this.outModes = new Tt, this.random = !1, this.size = !1, this.speed = 2, this.spin = new Rt, this.straight = !1, this.trail = new It, this.vibrate = !1, this.warp = !1
            }
            get bounce() {
            ...
            load(t) {
                ...
                this.angle.load("number" == typeof t.angle ? {
                    value: t.angle
                } : t.angle), this.attract.load(t.attract), this.center = M(null !== (i = this.center) && void 0 !== i ? i : {}, t.center), void 0 !== t.decay && (this.decay = t.decay), void 0 !== t.direction && (this.direction = t.direction), void 0 !== t.distance && (this.distance = "number" == typeof t.distance ? {
        ...
        class At extends xt {
            constructor() {
                super(), this.animation = new Et, this.random.minimumValue = .1, this.value = 1
            }
            get anim() {
        ...
        class Vt {
            ...
            load(t) {
                t && (void 0 !== t.blur && (this.blur = t.blur), this.color = Q.create(this.color, t.color), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.offset && (void 0 !== t.offset.x && (this.offset.x = t.offset.x), void 0 !== t.offset.y && (this.offset.y = t.offset.y)))
            }
        }
        class Wt {
            constructor() {
            ...
            load(t) {
                ...
                if (void 0 !== o)
                    for (const t in o) {
                        const i = o[t];
                        i && (this.options[t] = M(null !== (e = this.options[t]) && void 0 !== e ? e : {}, i))
                    }
                this.loadShape(t.character, "character", "char", !0), this.loadShape(t.polygon, "polygon", "star", !1), this.loadShape(null !== (s = t.image) && void 0 !== s ? s : t.images, "image", "images", !0), void 0 !== t.type && (this.type = t.type)
            }
            loadShape(t, i, e, s) {
                var o, n;
                if (!t) return;
                ...
                l && (this.options[i] = r), c && s && (this.options[e] = r), this.options[i] = M(null !== (o = this.options[i]) && void 0 !== o ? o : r, t), this.options[e] && !s || (this.options[e] = M(null !== (n = this.options[e]) && void 0 !== n ? n : r, t))
            }
        }
        class qt extends Lt {
            constructor() {
        ...
        class Ut extends xt {
            constructor() {
                super(), this.animation = new qt, this.random.minimumValue = 1, this.value = 3
            }
            get anim() {
                return this.animation
            }
        ...
        class Bt {
            ...
            load(t) {
                t && (void 0 !== t.color && (this.color = gt.create(this.color, t.color)), void 0 !== t.width && (this.width = t.width), void 0 !== t.opacity && (this.opacity = t.opacity))
            }
        }
        class Gt extends xt {
            constructor() {
        ...
        class jt {
            constructor(t, i) {
                this._engine = t, this._container = i, this.bounce = new _t, this.collisions = new Mt, this.color = new gt, this.color.value = "#fff", this.groups = {}, this.move = new Dt, this.number = new Ht, this.opacity = new At, this.reduceDuplicates = !1, this.shadow = new Vt, this.shape = new Wt, this.size = new Ut, this.stroke = new Bt, this.zIndex = new Gt
            }
            load(t) {
                var i, e, s, o, n, a;
                if (!t) return;
                if (this.bounce.load(t.bounce), this.color.load(gt.create(this.color, t.color)), void 0 !== t.groups)
                    for (const e in t.groups) {
                        const s = t.groups[e];
                        void 0 !== s && (this.groups[e] = M(null !== (i = this.groups[e]) && void 0 !== i ? i : {}, s))
                    }
                ...
                void 0 !== r && (this.collisions.enable = r), this.collisions.load(t.collisions), void 0 !== t.interactivity && (this.interactivity = M({}, t.interactivity));
                const l = null !== (n = t.stroke) && void 0 !== n ? n : null === (a = t.shape) || void 0 === a ? void 0 : a.stroke;
                if (l && (this.stroke = P(l, (t => {
                        const i = new Bt;
                        return i.load(t), i
                    }))), this._container) {
        ...
        class $t {
            constructor(t, i) {
                this._engine = t, this._container = i, this.autoPlay = !0, this.background = new K, this.backgroundMask = new it, this.fullScreen = new et, this.detectRetina = !0, this.duration = 0, this.fpsLimit = 120, this.interactivity = new ct(t, i), this.manualParticles = [], this.motion = new ut, this.particles = Yt(this._engine, this._container), this.pauseOnBlur = !0, this.pauseOnOutsideViewport = !0, this.responsive = [], this.smooth = !1, this.style = {}, this.themes = [], this.zLayers = 100
            }
            get backgroundMode() {
            ...
            load(t) {
                var i, e, s, o, n;
                if (!t) return;
                void 0 !== t.preset && P(t.preset, (t => this._importPreset(t))), void 0 !== t.autoPlay && (this.autoPlay = t.autoPlay);
                ...
                "boolean" == typeof l ? this.fullScreen.enable = l : this.fullScreen.load(l), this.backgroundMask.load(t.backgroundMask), this.interactivity.load(t.interactivity), void 0 !== t.manualParticles && (this.manualParticles = t.manualParticles.map((t => {
                    const i = new ht;
                    return i.load(t), i
                }))), this.motion.load(t.motion), this.particles.load(t.particles), this.style = M(this.style, t.style), this._engine.plugins.loadOptions(this, t), void 0 !== t.smooth && (this.smooth = t.smooth);
                ...
                this.defaultDarkTheme = null === (o = this._findDefaultTheme("dark")) || void 0 === o ? void 0 : o.name, this.defaultLightTheme = null === (n = this._findDefaultTheme("light")) || void 0 === n ? void 0 : n.name
            }
            setResponsive(t, i, e) {
                this.load(e);
        ...
        const Jt = t => {
            (w(t.outMode, t.checkModes) || w(t.outMode, t.checkModes)) && (t.coord > t.maxCoord - 2 * t.radius ? t.setCb(-t.radius) : t.coord < 2 * t.radius && t.setCb(t.radius))
        };
        class Zt {
            constructor(t, i, e, s, n, u) {
                var v, f, m, y, g, b, w, x, z, _, M, P, O;
                this.id = i, this.container = e, this.group = u, this._engine = t, this.fill = !0, this.pathRotation = !1, this.close = !0, this.lastPathTime = 0, this.destroyed = !1, this.unbreakable = !1, this.rotation = 0, this.misplaced = !1, this.retina = {
                    maxDistance: {}
                }, this.outType = "normal", this.ignoresResizeRatio = !0;
                const C = e.retina.pixelRatio,
                    S = e.actualOptions,
                    I = Yt(this._engine, e, S.particles),
                    T = I.shape.type,
                    D = I.reduceDuplicates;
                if (this.shape = k(T, this.id, D), null == n ? void 0 : n.shape) {
                    if (n.shape.type) {
                        const t = n.shape.type;
                        this.shape = k(t, this.id, D)
                    }
                    const t = new Wt;
                    t.load(n.shape), this.shape && (this.shapeData = this._loadShapeData(t, D))
                } else this.shapeData = this._loadShapeData(I.shape, D);
                I.load(n), I.load(null === (v = this.shapeData) || void 0 === v ? void 0 : v.particles), this.interactivity = new ct(t, e), this.interactivity.load(e.actualOptions.interactivity), this.interactivity.load(I.interactivity), this.fill = null !== (m = null === (f = this.shapeData) || void 0 === f ? void 0 : f.fill) && void 0 !== m ? m : this.fill, this.close = null !== (g = null === (y = this.shapeData) || void 0 === y ? void 0 : y.close) && void 0 !== g ? g : this.close, this.options = I;
                const L = this.options.move.path;
                this.pathDelay = 1e3 * p(L.delay), L.generator && (this.pathGenerator = this._engine.plugins.getPathGenerator(L.generator), this.pathGenerator && e.addPath(L.generator, this.pathGenerator) && this.pathGenerator.init(e));
                const E = c(this.options.zIndex.value);
                ...
                if (this.size = {
                        ...
                        value: c(A.value) * e.retina.pixelRatio,
                        max: d(F) * C,
                        min: h(F) * C,
                        loops: 0,
                        maxLoops: c(A.animation.count)
                    }, H.enable) {
                    switch (this.size.status = 0, this.size.decay = 1 - c(H.decay), H.startValue) {
                        case "min":
                            this.size.value = this.size.min, this.size.status = 0;
                            break;
                        case "random":
                            this.size.value = l(this.size) * C, this.size.status = a() >= .5 ? 0 : 1;
                            break;
                        default:
                            this.size.value = this.size.max, this.size.status = 1
                    }
                    this.size.velocity = (null !== (b = this.retina.sizeAnimationSpeed) && void 0 !== b ? b : e.retina.sizeAnimationSpeed) / 100 * e.retina.reduceFactor, H.sync || (this.size.velocity *= a())
                }
                this.bubble = {
                    inRange: !1
                }, this.slow = {
                    inRange: !1,
                    factor: 1
                }, this.position = this._calcPosition(e, s, r(E, 0, e.zLayers)), this.initialPosition = this.position.copy();
                const V = e.canvas.size,
                    W = this.options.move.center,
                    q = "percent" === W.mode;
                switch (this.moveCenter = {
                    x: (null !== (w = W.x) && void 0 !== w ? w : 50) * (q ? V.width / 100 : 1),
                    y: (null !== (x = W.y) && void 0 !== x ? x : 50) * (q ? V.height / 100 : 1),
                    radius: null !== (z = this.options.move.center.radius) && void 0 !== z ? z : 0,
                    mode: null !== (_ = this.options.move.center.mode) && void 0 !== _ ? _ : "percent"
                ...
                const U = e.particles;
                U.needsSort = U.needsSort || U.lastZIndex < this.position.z, U.lastZIndex = this.position.z, this.zIndexFactor = this.position.z / e.zLayers, this.sides = 24;
                let B = e.drawers.get(this.shape);
                B || (B = this._engine.plugins.getShapeDrawer(this.shape), B && e.drawers.set(this.shape, B)), (null == B ? void 0 : B.loadShape) && (null == B || B.loadShape(this));
                const G = null == B ? void 0 : B.getSidesCount;
                G && (this.sides = G(this)), this.spawning = !1, this.shadowColor = R(this.options.shadow.color);
                for (const t of e.particles.updaters) null === (M = t.init) || void 0 === M || M.call(t, this);
                for (const t of e.particles.movers) null === (P = t.init) || void 0 === P || P.call(t, this);
                (null == B ? void 0 : B.particleInit) && B.particleInit(e, this);
                for (const [, t] of e.plugins) null === (O = t.particleCreated) || void 0 === O || O.call(t, this)
            }
            destroy(t) {
            ...
            getFillColor() {
                var t, i;
                const e = null !== (t = this.bubble.color) && void 0 !== t ? t : W(this.color);
                if (e && this.roll && (this.backColor || this.roll.alter)) {
                    ...
                    if (Math.floor(((null !== (i = this.roll.angle) && void 0 !== i ? i : 0) + s) / (Math.PI / t)) % 2) {
                        if (this.backColor) return this.backColor;
                        if (this.roll.alter) return function (t, i, e) {
                            return {
                                h: t.h,
                                s: t.s,
                                l: t.l + ("darken" === i ? -1 : 1) * e
                            }
                        }(e, this.roll.alter.type, this.roll.alter.value)
                    }
                }
                return e
            }
            ...
            getStrokeColor() {
                var t, i;
                return null !== (i = null !== (t = this.bubble.color) && void 0 !== t ? t : W(this.strokeColor)) && void 0 !== i ? i : this.getFillColor()
            }
            isInsideCanvas() {
        ...
        class ii extends Kt {
            ...
            intersects(t) {
                t instanceof ti && t.intersects(this);
                const i = this.size.width,
                    e = this.size.height,
                    s = this.position,
                    o = t.position,
                    n = t instanceof ii ? t.size : {
                        width: 0,
                        height: 0
                    },
                    a = n.width,
        ...
        class ei {
            ...
            query(t, i, e) {
                ...
                for (const e of this.points) !t.contains(e.position) && f(t.position, e.position) > e.particle.getRadius() && (!i || i(e.particle)) || r.push(e.particle);
                return this.divided && (null === (s = this.northEast) || void 0 === s || s.query(t, i, r), null === (o = this.northWest) || void 0 === o || o.query(t, i, r), null === (n = this.southEast) || void 0 === n || n.query(t, i, r), null === (a = this.southWest) || void 0 === a || a.query(t, i, r)), r
            }
            queryCircle(t, i, e) {
                return this.query(new ti(t.x, t.y, i), e)
            }
            queryRectangle(t, i, e) {
                return this.query(new ii(t.x, t.y, i.width, i.height), e)
            }
            subdivide() {
                const t = this.rectangle.position.x,
                    ...
                    o = this.capacity;
                this.northEast = new ei(new ii(t, i, e / 2, s / 2), o), this.northWest = new ei(new ii(t + e / 2, i, e / 2, s / 2), o), this.southEast = new ei(new ii(t, i + s / 2, e / 2, s / 2), o), this.southWest = new ei(new ii(t + e / 2, i + s / 2, e / 2, s / 2), o), this.divided = !0
            }
        }
        class si {
            constructor(t, i) {
                this.container = i, this._engine = t, this.nextId = 0, this.array = [], this.zArray = [], this.limit = 0, this.needsSort = !1, this.lastZIndex = 0, this.interactionManager = new Nt(this._engine, i);
                const e = this.container.canvas.size;
                this.quadTree = new ei(new ii(-e.width / 4, -e.height / 4, 3 * e.width / 2, 3 * e.height / 2), 4), this.movers = this._engine.plugins.getMovers(i, !0), this.updaters = this._engine.plugins.getUpdaters(i, !0)
            }
            get count() {
            ...
            addManualParticles() {
                const t = this.container,
                    i = t.actualOptions;
                for (const n of i.manualParticles) this.addParticle((e = {
                    size: t.canvas.size,
                    position: n.position
                }, s = void 0, o = void 0, void 0 !== (null === (s = e.position) || void 0 === s ? void 0 : s.x) && void 0 !== (null === (o = e.position) || void 0 === o ? void 0 : o.y) ? {
            ...
            async draw(t) {
                ...
                this.quadTree = new ei(new ii(-e.width / 4, -e.height / 4, 3 * e.width / 2, 3 * e.height / 2), 4), i.canvas.clear(), await this.update(t), this.needsSort && (this.zArray.sort(((t, i) => i.position.z - t.position.z || t.id - i.id)), this.lastZIndex = this.zArray[this.zArray.length - 1].position.z, this.needsSort = !1);
            ...
            async update(t) {
                ...
                for (const i of this.array) {
                    ...
                    i.destroyed ? o.push(i) : this.quadTree.insert(new Qt(i.getPosition(), i))
                }
                for (const t of o) this.remove(t);
                await this.interactionManager.externalInteract(t);
                for (const i of s.particles.array) {
            ...
            _pushParticle(t, i, e, s) {
                try {
                    const o = new Zt(this._engine, this.nextId, this.container, t, i, e);
                    let n = !0;
                    if (s && (n = s(o)), !n) return;
        ...
        class oi {
            ...
            init() {
                const t = this.container,
                    i = t.actualOptions;
                this.pixelRatio = !i.detectRetina || g() ? 1 : window.devicePixelRatio;
                const e = this.container.actualOptions.motion;
                if (e && (e.disable || e.reduce.value)) {
                    const i = b("(prefers-reduced-motion: reduce)");
                    if (i) {
                        this._handleMotionChange(i);
                        const e = () => {
                            this._handleMotionChange(i), t.refresh().catch((() => {}))
                        };
                ...
                if (t.canvas.element) {
                    ...
                    t.canvas.size.width = i.offsetWidth * s, t.canvas.size.height = i.offsetHeight * s
                }
                const o = i.particles;
                this.attractDistance = c(o.move.attract.distance) * s, this.sizeAnimationSpeed = c(o.size.animation.speed) * s, this.maxSpeed = c(o.move.gravity.maxSpeed) * s
            }
            initParticle(t) {
                const i = t.options,
                    e = this.pixelRatio,
        ...
        class li {
            constructor(t, i, e) {
                this.id = i, this._engine = t, this.fpsLimit = 120, this.smooth = !1, this.duration = 0, this.lifeTime = 0, this._firstStart = !0, this.started = !1, this.destroyed = !1, this._paused = !0, this.lastFrameTime = 0, this.zLayers = 100, this.pageHidden = !1, this._sourceOptions = e, this._initialSourceOptions = e, this.retina = new oi(this), this.canvas = new $(this), this.particles = new si(this._engine, this), this.frameManager = new Z(this), this.pathGenerators = new Map, this.interactivity = {
                    mouse: {
                        clicking: !1,
                        inside: !1
                    }
                ...
                i.addEventListener("click", (t => {
                    ...
                    if (ni(this)) {
                        if (s && !o) {
                            ...
                            if (!o && (o = s.changedTouches[s.changedTouches.length - 1], !o)) return;
                            const r = null === (i = this.canvas.element) || void 0 === i ? void 0 : i.getBoundingClientRect(),
                                l = {
                                    x: o.clientX - (null !== (n = null == r ? void 0 : r.left) && void 0 !== n ? n : 0),
                                    y: o.clientY - (null !== (a = null == r ? void 0 : r.top) && void 0 !== a ? a : 0)
                                };
                            e(t, l, Math.max(o.radiusX, o.radiusY))
                        }
                        s = !1, o = !1
                    }
            ...
            addPath(t, i, e = !1) {
                return !(!ni(this) || !e && this.pathGenerators.has(t)) && (this.pathGenerators.set(t, null != i ? i : ri), !0)
            }
            destroy() {
                if (!ni(this)) return;
            ...
            draw(t) {
                if (!ni(this)) return;
                let i = t;
                this._drawAnimationFrame = (g() ? t => setTimeout(t) : t => (requestAnimationFrame || setTimeout)(t))((async t => {
            ...
            getAnimationStatus() {
                return !this._paused && !this.pageHidden && ni(this)
            }
            handleClickMode(t) {
                if (ni(this)) {
            ...
            async init() {
                ...
                this._options = ai(this._engine, this, this._initialSourceOptions, this.sourceOptions), this.actualOptions = ai(this._engine, this, this._options), this.retina.init(), this.canvas.init(), this.updateActualOptions(), this.canvas.initBackground(), this.canvas.resize(), this.zLayers = this.actualOptions.zLayers, this.duration = 1e3 * c(this.actualOptions.duration), this.lifeTime = 0, this.fpsLimit = this.actualOptions.fpsLimit > 0 ? this.actualOptions.fpsLimit : 120, this.smooth = this.actualOptions.smooth;
            ...
            async loadTheme(t) {
                ni(this) && (this._currentTheme = t, await this.refresh())
            }
            pause() {
                if (ni(this) && (void 0 !== this._drawAnimationFrame && ((g() ? t => clearTimeout(t) : t => (cancelAnimationFrame || clearTimeout)(t))(this._drawAnimationFrame), delete this._drawAnimationFrame), !this._paused)) {
            ...
            async refresh() {
                if (ni(this)) return this.stop(), this.start()
            }
            async reset() {
                if (ni(this)) return this._options = ai(this._engine, this), this.refresh()
            }
            setNoise(t, i, e) {
                ni(this) && this.setPath(t, i, e)
            }
            setPath(t, i, e) {
                if (!t || !ni(this)) return;
                const s = Object.assign({}, ri);
            ...
            stop() {
                ...
                if (ni(this) && this.started) {
                    ...
                    for (const [, i] of this.plugins) null === (t = i.stop) || void 0 === t || t.call(i);
            ...
            _intersectionManager(t) {
                if (ni(this) && this.actualOptions.pauseOnOutsideViewport)
        ...
        async function ci(t, i) {
            ...
            var o;
            o = s.status, console.error(`tsParticles - Error ${o} while retrieving config file`)
        }
        class hi {
            constructor(t) {
                this._engine = t
            ...
            async loadOptions(t) {
                ...
                let v;
                if ("canvas" === h.tagName.toLowerCase()) v = h, v.dataset.generated = "false";
                else {
                    const t = h.getElementsByTagName("canvas");
                    t.length ? (v = t[0], v.dataset.generated = "false") : (v = document.createElement("canvas"), v.dataset.generated = "true", h.appendChild(v))
                }
                v.style.width || (v.style.width = "100%"), v.style.height || (v.style.height = "100%");
                const f = new li(this._engine, o, d);
        ...
        class ui {
            ...
            addInteractor(t, i) {
                this.interactorsInitializers.set(t, i)
            }
            addParticleMover(t, i) {
                this.moversInitializers.set(t, i)
            }
            addParticleUpdater(t, i) {
                this.updatersInitializers.set(t, i)
            }
            ...
            getInteractors(t, i = !1) {
                return di(t, this.interactors, this.interactorsInitializers, i)
            }
            getMovers(t, i = !1) {
                return di(t, this.movers, this.moversInitializers, i)
            }
            getPathGenerator(t) {
            ...
            getUpdaters(t, i = !1) {
                return di(t, this.updaters, this.updatersInitializers, i)
            }
            loadOptions(t, i) {
        ...
        const pi = new class {
            ...
            vi = new class {
                ...
                handleColor(t) {
                    ...
                    if (void 0 !== e.h && void 0 !== e.l) return A(e)
                }
                handleRangeColor(t) {
                    var i;
                    const e = null !== (i = t.value.hsl) && void 0 !== i ? i : t.value;
                    if (void 0 !== e.h && void 0 !== e.l) return A({
                        h: c(e.h),
                        l: c(e.l),
                        s: c(e.s)
                    })
        ...
        const fi = new class {
            constructor() {
                this._domArray = [], this._eventDispatcher = new e, this._initialized = !1, this._loader = new hi(this), this.plugins = new ui(this)
            }
            addEventListener(t, i) {
        ...
        function gi(t, i, e, s, o) {
            ...
            o && 0 !== r.status ? (r.value -= h, r.value < 0 && (r.status = 0, r.value += r.value)) : (r.value += h, o && r.value > s && (r.status = 1, r.value -= r.value % s)), r.velocity && 1 !== d && (r.velocity *= d), r.value > s && (r.value %= s)
        }
        class bi {
            constructor(t) {
                this.container = t
            ...
            init(t) {
                const i = L(t.options.color, t.id, t.options.reduceDuplicates);
                i && (t.color = function (t, i, e) {
                    ...
                    return i && (q(s.h, i.h, e), q(s.s, i.s, e), q(s.l, i.l, e)), s
            ...
            update(t, i) {
                ! function (t, i) {
                    ...
                    void 0 !== (null === (e = t.color) || void 0 === e ? void 0 : e.h) && gi(i, t.color.h, n.h, 360, !1), void 0 !== (null === (s = t.color) || void 0 === s ? void 0 : s.s) && gi(i, t.color.s, n.s, 100, !0), void 0 !== (null === (o = t.color) || void 0 === o ? void 0 : o.l) && gi(i, t.color.l, n.l, 100, !0)
                }(t, i)
            }
        }
        class wi {
        ...
        class xi extends class {
            ...
            constructor(t) {
                super(t), this.handleClickMode = t => {
                    if ("push" !== t) return;
                    const i = this.container,
                        e = i.actualOptions.interactivity.modes.push;
                    if (!e) return;
                    const s = e.quantity;
                    if (s <= 0) return;
                    const o = x([void 0, ...e.groups]),
                        n = void 0 !== o ? i.actualOptions.particles.groups[o] : void 0;
                    i.particles.push(s, i.interactivity.mouse, n, o)
                }
            }
            clear() {}
            init() {}
            ...
            loadModeOptions(t, ...i) {
                t.push || (t.push = new wi);
                for (const e of i) t.push.load(null == e ? void 0 : e.push)
            }
            reset() {}
        }
        class zi {
            ...
            init(t) {
                ...
                const e = i.animation;
                if (e.enable) {
                    t.opacity.decay = 1 - c(e.decay), t.opacity.status = 0;
                    const s = i.value;
                    switch (t.opacity.min = h(s), t.opacity.max = d(s), e.startValue) {
                        case "min":
                            ...
                            break;
                        case "random":
                            t.opacity.value = l(t.opacity), t.opacity.status = a() >= .5 ? 0 : 1;
                            break;
                        default:
                ...
                this.isEnabled(t) && function (t, i) {
                    ...
                    if (!(t.destroyed || !t.opacity.enable || (null !== (s = t.opacity.maxLoops) && void 0 !== s ? s : 0) > 0 && (null !== (o = t.opacity.loops) && void 0 !== o ? o : 0) > (null !== (n = t.opacity.maxLoops) && void 0 !== n ? n : 0))) {
                        switch (t.opacity.status) {
                            case 0:
                                t.opacity.value >= h ? (t.opacity.status = 1, t.opacity.loops || (t.opacity.loops = 0), t.opacity.loops++) : t.opacity.value += (null !== (a = t.opacity.velocity) && void 0 !== a ? a : 0) * i.factor;
                                break;
                            case 1:
                                t.opacity.value <= c ? (t.opacity.status = 0, t.opacity.loops || (t.opacity.loops = 0), t.opacity.loops++) : t.opacity.value -= (null !== (l = t.opacity.velocity) && void 0 !== l ? l : 0) * i.factor
                        }
        ...
        class Mi {
            ...
            update(t, i, e, s) {
                ...
                switch (t.outType) {
                    case "normal":
                    case "outside":
                        if (z(t.position, n.canvas.size, o.origin, t.getRadius(), i)) return;
                        break;
                    case "inside": {
                        const {
                            dx: i,
        ...
        class Pi {
            ...
            update(t, i, e, s) {
                ...
                if (n.enable) {
                    ...
                    z(t.position, a.canvas.size, o.origin, l, i) || a.particles.remove(t)
                }
            }
        }
        class ki {
        ...
        class Oi {
            constructor(t) {
                this.container = t, this.updaters = [new _i(t), new Mi(t), new ki(t), new Pi(t)]
            }
            init() {}
            isEnabled(t) {
        ...
        async function Ii(t) {
            await async function (t) {
                t.addMover("base", (() => new mi))
            }(t), await async function (t) {
                await t.addInteractor("externalPush", (t => new xi(t)))
            }(t), await async function (t) {
                await t.addShape("circle", new yi)
            }(t), await async function (t) {
                await t.addParticleUpdater("color", (t => new bi(t)))
            }(t), await async function (t) {
                await t.addParticleUpdater("opacity", (t => new zi(t)))
            }(t), await async function (t) {
                await t.addParticleUpdater("outModes", (t => new Oi(t)))
            }(t), await async function (t) {
                await t.addParticleUpdater("size", (() => new Ci))
            }(t), await t.addPreset("fire", Si)
        }
        return Ii(fi), i
    }()
}));